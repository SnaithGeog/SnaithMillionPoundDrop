/* =========================
   SNAITH MILLIONAIRE v5.2 (Robust Start)
   ========================= */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const el = {
        ...
        btnReset: document.getElementById("btn-play-again"),
        text: {
    ...
    async function playAudio(type) {
        try {
            ...
            console.warn("Audio failed to play (user must interact first)", e);
        }
    }
    ...
    if(el.btnReveal) el.btnReveal.addEventListener('click', revealAnswer);
