const questions = [
    ...
    {
        story: "The Snaith traffic was gridlocked! The ambulance couldn't get through. I rang Mrs. Yeates screaming. 'Sort it out!' Mrs. Yeates rolled her eyes, grabbed the school credit card, and bought an AgustaWestland A109SP Helicopter online.",
        question: "How much did Mrs. Yeates pay for the helicopter?",
        options: { a: "£1.2 Million", b: "£2.6 Million", c: "£20 Million", d: "£200 Million" },
        correct: "b"
    },
    {
        story: "Mrs. Yeates landed the chopper on the school field, threw me in the back, and flew me directly to Hull Royal Infirmary with impressive speed.",
...
initBtn.addEventListener('click', () => {
    ...
    .catch(error => {
        alert("Audio failed to play. Ensure 'intro.mp3' is in the folder. Proceeding silently.");
        overlayScreen.classList.remove('active');
        startScreen.classList.add('active');
    });
});
...
function endGame() {
    ...
    document.getElementById('final-message').innerHTML = "I now owe <b>£149,102,248.82</b>.<br><br>Mrs. Yeates is absolutely furious with me.<br><br>Well done Snaith School!";
}