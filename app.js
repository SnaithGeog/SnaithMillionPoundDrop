const questions = [
    ...
    {
        story: "Mr. Harrison felt flush with cash. He visited Mr. Haggar in IT Support. 'You can't be seen with that old phone,' Mr. Haggar scoffed, pulling out a prototype iPhone 17 Pro Max (1TB). 'You need this for the school wifi.'",
    ...
    {
        story: "Mr. Harrison jumped into his 2020 Audi A3 parked in the staff car park. He stopped at the garage in Snaith. Mrs. Kilner filled the tank while tutting loudly at his driving.",
    ...
    {
        story: "Standing on the deck, Mr. Harrison felt underdressed. Mr. Wilson appeared from below deck holding a sparkling object. 'You can't be a captain without the Golden Captain's Hat,' Mr. Wilson insisted. 'It's tradition.'",
        question: "How much did Mr. Wilson charge for the Golden Hat?",
        options: { a: "£50", b: "£500", c: "£5,000", d: "£15.99" },
        correct: "b"
    },
    {
        story: "Mr. Harrison finally passed out. He woke up back in his classroom, cold and alone. He checked his bank balance and realized he had spent a fortune based on terrible advice from the Snaith School staff.",
...
// Step 1: User taps to enter (Enables Audio Context)
initBtn.addEventListener('click', () => {
    overlayScreen.classList.remove('active');
    startScreen.classList.add('active');
    
    // Play Intro Theme
    musicIntro.play().catch(e => console.log("Audio failed:", e));
});

// Step 2: User starts game (Switches Music)
startBtn.addEventListener('click', () => {
    startScreen.classList.remove('active');
    gameScreen.classList.add('active');
    
    // Fade out intro, play game loop
    musicIntro.pause();
    musicGame.play().catch(e => console.log("Audio failed:", e));
