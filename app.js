/* =========================
   Snaith Millionaire v2.1
   - Fixed "Stuck on start screen" bug
   - Story updated to 3rd Person ("Mr. Harrison...")
   ========================= */

const questions = [
    {
        story: "Mr. Harrison's disastrous day began when he woke up in the staff room, absolutely famished. He called Mrs. Gravel for advice. 'Harrison!' she yelled. 'Stop eating dusty cereal! Run to the Co-op in Snaith and get some proper bacon!' Mr. Harrison obeyed instantly and ran all the way down Pontefract Road.",
        question: "How much did Mr. Harrison pay the Co-op for 6 slices of bacon?",
        options: { a: "£25", b: "20p", c: "£1.46", d: "£2.50" },
        correct: "d"
    },
    {
        story: "Walking back with his bacon, Mr. Harrison found 6 duck eggs near the pond. Miss McCloud suddenly burst out of the science block. 'Harrison! I need those eggs for a volatile custard experiment!' she screamed, shoving cash into his hand and running off with them.",
        question: "How much did Miss McCloud pay Mr. Harrison for the 6 duck eggs?",
        options: { a: "£5", b: "£2.50", c: "30p", d: "£1,500" },
        correct: "b"
    },
    {
        story: "Flush with cash from the egg deal, Mr. Harrison strutted into the IT office. Mr. Haggar looked up. 'You can't be a high-roller with that ancient phone,' he scoffed. 'You need the prototype iPhone 17 Pro Max (1TB). It's the only thing compatible with the new school Wi-Fi.'",
        question: "How much did Mr. Harrison pay Mr. Haggar for the iPhone 17 Pro Max?",
        options: { a: "£1,599", b: "£979", c: "£279", d: "£67.90" },
        correct: "a"
    },
    {
        story: "Desperate to test his new phone, Mr. Harrison called Mr. Ward. 'I'm bored,' he moaned. 'Perfect timing,' Mr. Ward replied. 'Buy my Saddleback pig. It's eating all the Year 7 homework and needs to go before Ofsted arrives.'",
    ...
    {
        story: "With a pig in the car, he needed space. He drove to a farm outside Snaith where Mr. Collins was weeping into a bucket. 'Harrison! The marking load is too high! Buy my 9.5 acres and Ms. Wilson's wild stallion so I can retire!' It seemed like the perfect home for the pig, so Mr. Harrison agreed.",
        question: "How much did Mr. Harrison pay Mr. Collins for the farm?",
        options: { a: "£200,000", b: "£1.6 Billion", c: "£500,000", d: "£1.5 Million" },
        correct: "d"
    },
    {
        story: "Now Mr. Harrison owned a farm, but the stallion looked hangry. He called Mrs. Edge. 'Do horses eat bacon?' he asked. Mrs. Edge sighed deeply. 'No, Harrison, you fool. I'm bringing a bale of premium hay. Meet me at the gate.'",
        question: "How much did Mr. Harrison pay Mrs. Edge for the hay?",
        options: { a: "£1", b: "£5.20", c: "£10", d: "£15" },
        correct: "b"
    },
    {
        story: "Mr. Harrison was now broke from buying the farm. He asked Mr. Francis for a business plan. 'Simple,' Mr. Francis declared, putting on a riding helmet. 'We use the horse to start an Elite Riding School. We'll charge the parents a fortune.'",
        question: "How much did Mr. Harrison charge for a 45min riding lesson?",
        options: { a: "£58", b: "£78", c: "£28", d: "£38" },
        correct: "c"
    },
    {
        story: "During the very first lesson, Mr. Harrison tripped over the pig and snapped his leg. 'Help!' he cried. Miss Maguinness looked up from her book. 'I have a foil blanket in my bag, Harrison, but nothing in this life is free.'",
    ...
    {
        story: "He stood on the deck of his new yacht, but felt underdressed. Mr. Wilson appeared from below deck holding a sparkling object. 'You can't be a captain without the Golden Captain's Hat, Harrison,' Mr. Wilson insisted. 'It's tradition.'",
...
const el = {
  ...
  btnEnter: document.getElementById("btn-enter"), // The single button
...
function loadQuestion() {
  ...
  el.status.textContent = "Ready to reveal.";
}
...
function revealCorrect() {
  ...
  el.status.textContent = "Answer: " + k.toUpperCase();
}
...
function endGame() {
  ...
  show(el.end);
  el.final.innerHTML = "I now owe <b>£149,102,248.82</b>.<br><br>Mrs. Yates is absolutely furious.<br><br>Well done Snaith School!";
}
...
el.btnEnter.addEventListener("click", async () => {
  // 1. Try to play audio (if allowed)
  await safePlay(el.gameMusic); 
  // 2. IMMEDIATELY start the game logic regardless of audio success
  startGame(); 
});
